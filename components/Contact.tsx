export default function Contact() {
  ...
  return (
    <section id="kontakt" className="bg-brand-black py-20 sm:py-28">
      <div className="container-x">
        <div className="max-w-3xl">
          <span className="accent-line" />
          <h2 className="section-heading mt-5">Kontakt & Terminvereinbarung</h2>
        ...
        <div className="mt-14 grid lg:grid-cols-2 gap-8 lg:gap-12">
          <div className="rounded-2xl bg-brand-dark p-8 sm:p-10 ring-1 ring-white/5">
            <h3 className="font-heading text-2xl font-bold">KFZ-Service Kaya</h3>
            <p className="mt-1 text-white/65">Inhaber: Mustafa Kaya</p>
            ...
            <ul className="mt-8 space-y-5">
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-white">Neppersbergstraße 10</p>
                  <p className="text-white">73525 Schwäbisch Gmünd</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-brand-green/15 text-brand-green">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="mt-1 block text-white hover:text-brand-green"
                  >
                    0179 / 6641413
                  </a>
                </div>
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="mt-1 block text-white hover:text-brand-green break-all"
                  >
          ...
          <div className="overflow-hidden rounded-2xl ring-1 ring-white/5 bg-brand-dark min-h-[420px]">
            <iframe
        ...
        <div className="mt-14 rounded-2xl bg-gradient-to-r from-brand-green/15 via-brand-green/5 to-transparent border border-brand-green/30 p-8 sm:p-10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-white/75 max-w-2xl">
                ...
                Ihnen gerne weiter und vereinbaren einen passenden Termin.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a href="mailto:kfz-service.kaya@web.de" className="btn-secondary">
                E-Mail schreiben
              </a>
            </div>
          </div>
